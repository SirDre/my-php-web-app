...
function productsForm($productCode, $productName, $productLine, $productScale, $productVendor, $productDescription, $quantityInStock, $buyPrice, $MSRP, $error)
 {
	...
	if (is_numeric($_POST['employeeNumber']))
	{
	 ...
	 if ($lastName == '' || $lastName == ''  )
	 {
		 ...
		 $error = 'ERROR: Please fill in all required fields!';
			...
			productsForm($productCode, $productName, $productLine, $productScale, $productVendor, $productDescription, $quantityInStock, $buyPrice, $MSRP, $error);
	 }else {
